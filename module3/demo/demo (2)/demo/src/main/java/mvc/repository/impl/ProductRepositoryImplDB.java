...
public class ProductRepositoryImplDB implements ProductRepository {
    private ProductTypeRepository typeRepository = new ProductTypeRepositoryImpl();
    ...
    public void create(Product product) throws Exception {
        ...
        try (
            ...
            statement.setString(6, product.getType().getId());
    ...
    public Product findById(String id) throws SQLException, ClassNotFoundException {
        try (
            ...
            if (rs.next()) {
                ...
                ProductType type = typeRepository.findById(type_id);
                return new Product(id, name, price, dateRelease, quantity, type);
            }
        }
        return null;
    }
    ...
    public List<Product> findAll() throws SQLException, ClassNotFoundException {
        ...
        try (Connection connection = ConnectionUtils.getConnection();
            ...
            while (rs.next()) {
                ...
                String type_id = rs.getString("type_id");
                ProductType type = typeRepository.findById(type_id);
                products.add(new Product(id, name, price, dateRelease, quantity, type));
            }
        }
        return products;
    }
    ...
    public int countRecord() throws SQLException, ClassNotFoundException {
        try (Connection connection = ConnectionUtils.getConnection();
             Statement statement = connection.createStatement();
             ResultSet rs = statement.executeQuery(Constants.COUNT_RECORD_PRODUCT);) {
            while (rs.next()) {
                return rs.getInt(1);
            }
        }
